...
public class LocalPlaceAction2 implements Action {
  ...
  public String execute(HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      for(Element item : item_list) {
        ...
        //vo객체로 생성하자
        mybatis.vo.DataVO vo = new mybatis.vo.DataVO(title, mapx, mapy, addr1, addr2, firstimage, firstimage2, tel, eventstartdate, eventenddate);
    ...
    sb2.append("serviceKey=FDp2a3vCnN%2BVvgfwp%2BneIQPvN3zTM7aLpEznSGbkyDN47qXAmtPene0L3A8mgUsbO%2F7pzLR3EX7rdD0%2B6wZe3Q%3D%3D");
    sb2.append("&numOfRows=1000");
    sb2.append("&pageNo=1");
    sb2.append("&MobileOS=ETC");
    sb2.append("&MobileApp=AppTest");
    sb2.append("&arrange=A");
    sb2.append("&listYN=Y");
    ...
    try {
      ...
      if (contentId != null && !contentId.isEmpty()) {
        sb2.append("&areaCode=" + contentId); // 예: &areaCode=1
      }
